...
repository intentionally uses private Home Assistant HTTP endpoints and writes
private `.storage` files during first boot. Do not describe those interfaces as
